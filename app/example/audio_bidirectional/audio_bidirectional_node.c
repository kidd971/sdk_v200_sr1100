...
/* The SWC receives and produces audio samples at a rate of 48 kHz with a 24-bit depth. */
#define SAC_MAIN_CHANNEL_PRODUCER_PAYLOAD_SIZE 120
/* The codec consumes audio samples at a rate of 48 kHz with a 24-bit depth encoded on 32 bits. */
#define SAC_MAIN_CHANNEL_CONSUMER_PAYLOAD_SIZE 160
/* The codec produces audio samples at a rate of 48 kHz with a 24-bit depth encoded on 32 bits. */
#define SAC_BACK_CHANNEL_PRODUCER_PAYLOAD_SIZE 312
/* The SWC consumes and sends audio samples at a rate of 32 kHz with a 16-bit depth. */
#define SAC_BACK_CHANNEL_CONSUMER_PAYLOAD_SIZE 104
...
/* The Node receives audio samples at a rate of 48 kHz. */
#define SAC_MAIN_CHANNEL_SAMPLING_RATE 48000
...
#define SAC_BACK_CHANNEL_FALLBACK_PAYLOAD_SIZE \
    (SAC_BACK_CHANNEL_CONSUMER_PAYLOAD_SIZE * FALLBACK_SAMPLE_RESOLUTION / SAC_16BITS)
/* A header is added to compressed audio samples during fallback. */
#define SAC_BACK_CHANNEL_FALLBACK_HEADER_SIZE \
    (sizeof(sac_header_t) + SAC_COMPRESSION_HEADER_SIZE(SAC_BACK_CHANNEL_COUNT))
...
static void app_swc_core_init(pairing_assigned_address_t *pairing_assigned_address, swc_error_t *swc_err)
{
    ...
    uint8_t fallback_thresholds[] = {SAC_BACK_CHANNEL_FALLBACK_PAYLOAD_SIZE + SAC_BACK_CHANNEL_FALLBACK_HEADER_SIZE};
    ...
    swc_connection_cfg_t rx_audio_conn_cfg = {
        ...
        .max_payload_size = SAC_MAIN_CHANNEL_PRODUCER_PAYLOAD_SIZE + sizeof(sac_header_t),
    ...
    swc_connection_cfg_t tx_audio_conn_cfg = {
        ...
        .max_payload_size = SAC_BACK_CHANNEL_CONSUMER_PAYLOAD_SIZE + sizeof(sac_header_t),
...
static void app_audio_core_init(void)
{
    ...
    /* ** Endpoint Interfaces ** */
    sac_endpoint_interface_t main_channel_i2s_consumer_iface;
    sac_endpoint_interface_t main_channel_swc_producer_iface;
    sac_endpoint_interface_t back_channel_i2s_producer_iface;
    sac_endpoint_interface_t back_channel_swc_consumer_iface;

    /* ** Processing Stages Interfaces ** */
    sac_processing_interface_t fallback_iface;
    sac_processing_interface_t main_channel_unpacking_iface;
    sac_processing_interface_t main_channel_decompression_iface;
    sac_processing_interface_t main_channel_volume_iface;
    sac_processing_interface_t main_channel_mute_on_underflow_iface;
    sac_processing_interface_t back_channel_packing_iface;
    sac_processing_interface_t back_channel_compression_iface;
    sac_processing_interface_t back_channel_compression_discard_iface;
    sac_processing_interface_t back_channel_downsampling_iface;
    ...
    main_channel_mute_on_underflow_instance.reload_value =
        sac_get_nb_packets_in_x_ms(30, SAC_MAIN_CHANNEL_CONSUMER_PAYLOAD_SIZE, SAC_MAIN_CHANNEL_COUNT,
                                   I2S_SAC_SAMPLE_FORMAT, SAC_MAIN_CHANNEL_SAMPLING_RATE);
    ...
    back_channel_fallback_instance.cca_max_try_count = FALLBACK_CCA_TRY_COUNT;
    ...
    back_channel_downsampling_instance.cfg.channel_count = SAC_BACK_CHANNEL_COUNT;
    ...
    back_channel_downsampling_instance.cfg.payload_size = SAC_BACK_CHANNEL_PRODUCER_PAYLOAD_SIZE / 2;
...
/** @brief Callback handles the printing of statistics and also sends the link margin and the button state every 10 ms.
 */
static void data_callback(void)
{
