...
#endif
        break;
    case FRAME_RECEIVED_DATA_SIZE_INVALID:
        lqi->received_data_size_invalid_count++;
        break;
    case FRAME_RECEIVED_HEADER_SIZE_INVALID:
        lqi->received_header_size_invalid_count++;
        break;
    case FRAME_REJECTED:
        lqi->rejected_count++;
        /* Update the instantaneous RSSI and RNSI codes from the radio register. */
