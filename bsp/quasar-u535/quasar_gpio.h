...
/* MACROS *********************************************************************/
/* Return the global interrupt of the selected GPIO pin from quasar_gpio_pin_t. */
#define QUASAR_GPIO_GET_SELECTED_IRQ(gpio_pin) ((IRQn_Type)(EXTI0_IRQn + (gpio_pin)))
 ...
 *
 *  @param[in] gpio_port  The reference GPIO port of the HAL to be set.
 ...
 *  @note The GPIO must have been initialized in output mode.
 *
 *  @param[in] gpio_port  The reference GPIO port of the HAL to be clear.
 *  @param[in] gpio_pin   The GPIO pin to clear.
 */
 ...
 *  @note The GPIO must have been initialized in output mode.
 *
 *  @param[in] gpio_port  The reference GPIO port of the HAL to be toggled.
 *  @param[in] gpio_pin   The GPIO pin to toggle.
 */
 ...
 *
 *  @param[in] gpio_port  The reference GPIO port of the HAL to be read.
 *  @param[in] gpio_pin   The output GPIO pin to read.
