...
/* PUBLIC FUNCTIONS ***********************************************************/
void quasar_memory_read(uint32_t flash_address, const void *read_buffer, uint32_t buffer_size,
...
void quasar_memory_write(uint32_t flash_address, const void *write_buffer, uint32_t buffer_size,
                         quasar_memory_error_t *err)
{
...
static quasar_memory_error_t memory_verify_status(HAL_StatusTypeDef status)
{
    quasar_memory_error_t err = QUASAR_MEMORY_ERROR_NO_ERROR;
