...
/* CONSTANTS ******************************************************************/
/* Offset to apply to channel selection from channel 8 and above. */
#define QUASAR_DMA_SELECTION_GPDMA1_CHANNEL8_OFFSET 72
...
/** @brief Populate both TX and RX DMA handle.
 *
 *  @note QSPI DMA handle are populated at init only so that there is less processing needed at runtime since DMA is
 *        initialized at every transfer.
 *
 *  @param[in] dma_config  Configuration of the DMA peripheral.
 */
